...
import { createGroupPost, clearErrors } from '../../redux/actions/dataActions';
...
class CreateGroupPost extends Component {
    ...
    handleSubmit = (event) => {
        ...
        this.props.createGroupPost({ title: this.state.title, 
...
export default connect(mapStateToProps, { createGroupPost, clearErrors })(withStyles(styles)(withRouter(CreateGroupPost)));
