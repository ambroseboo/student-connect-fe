...
class DeleteListingInListing extends Component {
    state = {
        open: false
    };
    handleOpen = () => {
    ...
    deletePost = () => {
        this.props.deleteListing(this.props.postId);
        this.setState({ open: false });
...
DeleteListingInListing.propTypes = {
    deleteListing: PropTypes.func.isRequired,
    classes: PropTypes.object.isRequired,
    postId: PropTypes.string.isRequired
}

export default connect(null, { deleteListing })(withStyles(styles)(DeleteListingInListing));
